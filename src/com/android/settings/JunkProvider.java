...
public class JunkProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.android.settings", "quiettime", QUIET_TIME);
 ...
 /*   @Override
    ...
    public String getType(Uri url) {
        ...
        switch (match) {
            case QUIET_TIME:
                return "vnd.android.cursor.dir/quiettime";
            case QUIET_TIME_ID:
                return "vnd.android.cursor.item/quiettime";
            default:
...
/*    @Override
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        switch (match) {
            case QUIET_TIME_ID: {
                ...
                count = db.update("quiettime", values, "_id=" + rowId, null);
                break;
            }
            default: {
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        if (sURLMatcher.match(url) != QUIET_TIME) {
    ...
    public int delete(Uri url, String where, String[] whereArgs) {
        ...
        switch (sURLMatcher.match(url)) {
            case QUIET_TIME:
                count = db.delete("quiettime", where, whereArgs);
                break;
            case QUIET_TIME_ID:
                String segment = url.getPathSegments().get(1);
                rowId = Long.parseLong(segment);
